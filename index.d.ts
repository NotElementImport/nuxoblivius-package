...
declare export default m as typeof StateManager
declare export function useStore<T>(name: string, obj: typeof SM): T
...
// declare class IFormModel extends IStateManager<any> {
