...
type PatternsApi = "yii2-data-provider" | ""
type PlaceKeep = "cookie" | "localStorage" | "cache"
type AuthType = "bearer-token" | "login-password" | "api-key"

type StateValue<T> = T
type StateQuery = {[name: string]: string|number|boolean|StateQuery}
...
interface IStateApi<T> {
    ...
    join(object: IState<T>|IStateFin<T>|string, field?:string): IStateApi<T>
...
type IStateAny = IState<any> | IStateFin<any> | IStateApi<any> | IStateApiPagi<any> | StateValue<any> | IStateApiPagiMany<any> | IStateApiOne<any> | IStateApiMany<any>
